...
from .swin_transformer_vis import SwinTransformer
...
def build_model():
    ...
    if True:#opt.model_type == 'swin':
        model = SwinTransformer(img_size= img_size,#config.DATA.IMG_SIZE,
                                ...
                                use_checkpoint=True)#config.TRAIN.USE_CHECKPOINT)
    #else:
    ...
    snapshot_name = '/mnt/sdb/tangfeilong/Retinal_OCT/Confidence_MedIA/pretrain/swin_base_patch4_window12_384.pth'
